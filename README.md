...
2. Envie `index.html` e este `README.md` para a branch principal.
...
- **Temas:** SEO local, omnichannel, automação, analytics, IA generativa (fluxo de sugestões), marketing digital e varejo.
- **UX:** fluxo curto, resultado imediato, score e prévias visuais.
- **Identidade:** linguagem e interface próprias para varejo local.
- **Criatividade:** uma oferta vira ativos para vários canais e dados estruturados.
